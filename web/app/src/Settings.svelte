<script>
  ...
  import { VERSION, REPO_URL, releaseUrl, versionNotice, versionLabel, commitUrl, versionInfo } from "./lib/version.js";
  ...
  <div class="body">
    ...
    {:else}
      <section class="card">
        ...
        <p class="muted">{#if git?.ahead}{versionLabel(VERSION, git)} · <a href={commitUrl(git)} target="_blank" rel="noopener">commit</a> · {/if}Build <code>{build}</code></p>
