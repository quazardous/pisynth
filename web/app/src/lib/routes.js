...
// panel behind the cog (Sound, Metronome, Display, Musicians, Latency, About). Old links keep working. Pure, tested under Node.

export const PANELS = ["sound", "metronome", "display", "musicians", "latency", "about"];
